---
slug: honeypot_1
title: Tutorial - Installing and Configuring a Honeypot in Google Cloud (Part 1)
sidebar_position: 2
image: https://2.bp.blogspot.com/-uBOZREOgV8g/XAlWmAMiNFI/AAAAAAAAPNc/9u3q9RoHJyIjbq0f7GY_9SXicUOkNSCHgCLcBGAs/s1600/Winnie_the_Pooh_is_about_to_eat_honey.jpg
---
...
2. Basic knowledge of firewalls.
...
![image](/img/honeypot_tut/chrome_WqqFATEFXI.png)

:::info

Notice how port **64295** is not in the rule, that's because its required to be open to Google's servers so we can use SSH through Google Cloud.
...
Check out [Part 2](/docs/tutorials/honeypot_2) where we'll start installing and configuring the honeypot itself!

If you have any comments or feedback, don't hesitate to contact me [here.](mailto:nathan@nburns.tech?Subject=Honeypot_Part1_Feedback)

## References
1. https://github.com/telekom-security/tpotce (Documentation on what port numbers to allow/block)
